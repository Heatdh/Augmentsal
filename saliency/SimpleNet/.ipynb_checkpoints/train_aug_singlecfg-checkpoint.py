...
def config_Wb(args,name):
    """ Configure wb
    """
    unique_id=wandb.util.generate_id()
    wandb.init(id= unique_id,name=name, project="Saliency", entity="heatdh", config=args)

def dump_args(args):
    with open(os.path.join('cfg_aug/default_cfg.json'), 'w') as f:
...
if __name__ == '__main__':
    ...
    # augment specific
    parser.add_argument('--train_im',default="dataset/images/train/", type=str)
    parser.add_argument('--train_maps',default="dataset/maps/train/", type=str)
    parser.add_argument('--name',default="unamed", type=str)
    ...
    #dump_args(args)
    config_Wb(args,args.name)
    train_img_dir = args.train_im
    train_gt_dir = args.train_maps
